...
public class CreateUAMScenario {
    public static void main(String[] args) {
        ...
        String[] scenarioArgs = {"scenarios/1-percent/sao_paulo_config.xml", "/home/tumtse/Documents/haowu/uam/uam/src/main/java/org/eqasim/sao_paulo/siting/initialization/stations.csv", "100", "1000000", "src/main/java/org/eqasim/sao_paulo/siting/initialization/vehicles.csv"};
